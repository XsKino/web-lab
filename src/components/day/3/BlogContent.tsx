...
const KinoIcon = (): JSX.Element => (
  <svg
    className='h-[1em] inline text-inherit'
...
export default function BlogContent(): JSX.Element {
  return (
    <section className='py-16 pt-20 px-4 md:px-0 flex-col'>
      <h1 className='font-["Bebas_Neue"] font-bold text-4xl md:text-8xl text-center text-transparent bg-clip-text bg-gradient-to-t from-transparent to-white'>
        Should I plan a vacation to the sun?
      </h1>
      <hr className='rounded-full opacity-20 my-4' />
      <h4 className='text-lg text-end opacity-50'>
        <KinoIcon /> By ChatGPT
      </h4>
      <p className='mt-8 text-xl md:text-2xl'>
        As tempting as it might be to escape Earth{`'`}s daily grind and take a trip to the sun, experts are
        quick to point out why this seemingly out-of-this-world vacation idea is, in reality, a hot mess
        waiting to happen.
      </p>
      ...
      <p className='mt-8 text-xl md:text-2xl'>
        ...
        <br />
        The sun{`'`}s surface temperature reaches a scorching 5,500 degrees Celsius (9,932 degrees
        Fahrenheit). Any spacecraft or space suit we currently have would be reduced to a puddle of molten
        metal within moments of entering the sun{`'`}s outer layers. It{`'`}s safe to say that packing your
        sunscreen won
        {`'`}t cut it for this journey.
        <br />
        <br />
        <span className='font-bold text-2xl md:3xl'>Intense Radiation</span>
        <br />
        The sun emits powerful solar radiation, including ultraviolet and X-rays, which can be extremely
        harmful to living organisms. Our protective ozone layer on Earth shields us from the majority of these
        harmful rays. Traveling to the sun would expose any unfortunate astronauts to lethal doses of
        radiation, leading to serious health risks.
        <br />
        <br />
        <span className='font-bold text-2xl md:3xl'>No Solid Ground</span>
        <br />
        Unlike Earth, the sun is a giant ball of superheated gas with no solid surface to stand on. Any
        attempt to land on the sun would be met with the lack of a landing spot, making it an impossible
        destination for traditional travel.
        <br />
        <br />
        <span className='font-bold text-2xl md:3xl'>Technological Limitations</span>
        <br />
        Even if we could somehow engineer a spacecraft capable of withstanding the extreme conditions near the
        sun, the energy requirements for such a journey would be astronomical. Current propulsion technologies
        are not up to the task of reaching the sun and returning safely.
        <br />
        <br />
        <span className='font-bold text-2xl md:3xl'>Costly Expedition</span>
        <br />
        Building a spacecraft capable of venturing into the sun{`'`}s atmosphere would require a budget that
        {`'`}s literally out of this world. The sheer technological challenges and risks involved in such a
        mission make it a financially impractical endeavor. In conclusion, while the idea of a sun-soaked
        vacation might sound appealing, the reality is that traveling to the sun is a recipe for disaster.
        From the unfathomable temperatures to the intense radiation and lack of solid ground, our current
        understanding of science and technology makes a sun vacation nothing more than a burning fantasy. It
        seems Earth
        {`'`}s beaches will have to suffice for now, and interstellar travel planners might want to consider
        cooler destinations.
      </p>
    </section>
  )
